...
class LoginController extends Controller
{
    ...
    */
    ...
    public function processLogin(LoginRequest $request)
    {
        ...
        if (auth()->attempt(['email' => $request->email, 'password' => $request->password, 'status' => config('constants.user.status.active')], $request->has('remember'))) {
    ...
    {
        if (old('message') || old('error')) {
            return view('frontend.auth.message');
        }
