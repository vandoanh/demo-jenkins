...
<section class="container">
    <div class="row">
        ...
        <div class="col-12 col-lg-8 col-xl-9">
            <form id="formPost" action="{!! route('user.post.store') !!}" method="POST" novalidate>
                {{ csrf_field() }}
                <div class="form-row justify-content-center">
                    <div class="col-12 col-lg-8">
                        <div class="form-group">
                            <label class="form-label form-required">Tiêu đề</label>
                            <input type="text" class="form-control" id="title" name="title" value="{{ old('title') }}" placeholder="Tiêu đề" data-code="true" data-for="#code" data-link="{!! route('backend.create-code') !!}" aria-required="true">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="5" placeholder="Tóm tắt">{{ old('description') }}</textarea>
                            {!! show_error($errors, 'description') !!}
                        </div>
                        <div class="form-group">
                            <label class="form-label form-required">Nội dung</label>
                            <textarea class="form-control" id="content" name="content" placeholder="Nội dung" data-editor="{{ json_encode(['width' => '99%', 'height' => '425px']) }}">{{ old('content') }}</textarea>
                        ...
                        <div class="form-row">
                            <div class="col-12 form-group">
                                ...
                                <div data-for="category_id" class="list-folder p-3 border rounded">
                                    @include('frontend.user.post.partials.list_category', ['arrListCategory' => $listCategory, 'arrListOn' => old('category_liston', []), 'selected' => old('category_id')])
                                </div>
